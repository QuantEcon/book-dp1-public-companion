...
chapter_meta = {
                "introductions": {
                    ...
                    "linear_iter.py" : [],
                    "linear_iter_fig.py" : [],
                    "iid_job_search.py" : ["fig_vseq(savefig=True)", "fig_vstar(savefig=True)"]
                    }
                },
                "operators_fixed_points": {
                    "name": "Operators and Fixed Points",
                    "subs": {
                    "lake.py" : ["plot_paths(savefig=True)", "plot_growth(savefig=True)"], #to be added to python
                    #"lake_1.py"
                    }
                },
                "markov_dynamics": {
...
#                    "inventory_sim.py",
                ...
                "stochastic_discounting": {
                    ...
                    "subs": {
                    "plot_interest_rates.py" : ["plot_rates(df_nominal, savefig=True)", "plot_rates(df_real, savefig=True)"], #to be added to python
                ...
                "recursive_decision_processes": {
                    ...
                    "subs": {
                    "quantile_function.py" : [], #to be added to python
                    "quantile_js.py" : ["plot_main(savefig=True)"] #to be added to python
                    }
                }
                }
